...
namespace NEKO
{
    Shadder::Shadder(const std::string &vertex_src, const std::string &fragment_src)
    {
    ...
    Shadder::~Shadder() { glDeleteProgram(m_RendererID); }

    void Shadder::Bind() const
    {
        glUseProgram(m_RendererID);
    }

    void Shadder::UnBind() const
    {
        glUseProgram(0);
    }
